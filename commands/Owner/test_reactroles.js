...
module.exports.run = async (bot, message, args, client) => {
  ...
  const reactionRoles = [
    ...
    {
      name: 'Grey',
      reaction: bot.emojis.get("726404996383637514"),
      reactionRole: message.guild.roles.get('701023701566750781')
    },
    {
      name: 'Magenta',
      reaction: '💟',
      reactionRole: message.guild.roles.get('595507447112925204'),
    },
    {
      name: 'Purple',
      reaction: '🟪',
      reactionRole: message.guild.roles.get('595507863355654154'),
    },
    {
      name: 'Red',
      reaction: '🟥',
      reactionRole: message.guild.roles.get('595506989212106802'),
    },
    {
      name: 'Orange',
      reaction: '🟧',
      reactionRole: message.guild.roles.get('595507331396009986'),
    },
    {
      name: 'Yellow',
      reaction: '🟨',
      reactionRole: message.guild.roles.get('595507180183093248'),
    },
    {
      name: 'Green',
      reaction: '🟩',
      reactionRole: message.guild.roles.get('595507124574879744'),
    },
    {
      name: 'Cyan',
      reaction: bot.emojis.get("726404996358340608"),
      reactionRole: message.guild.roles.get('701023419931820052')
    },
    {
      name: 'Blue',
      reaction: '🟦',
      reactionRole: message.guild.roles.get('595507043629268993'),
    },
