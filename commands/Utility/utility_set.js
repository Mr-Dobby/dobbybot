...
module.exports.run = async (bot, message, args, client) => {
    ...
    let incidentError = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag} | Set Incident Log`, message.author.displayAvatarURL)
    ...
    let serverError = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag} | Set Server Log`, message.author.displayAvatarURL)
    ...
    let raidError = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag} | Set Raid Log`, message.author.displayAvatarURL)
    ...
    let welcomeError = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag} | Set Welcome Log`, message.author.displayAvatarURL)
    ...
    let ticketsysError = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag} | Set Ticket System`, message.author.displayAvatarURL)
  ...
  switch (action) {
        ...
        case 'incidentlog': 
            var newLog = (args[1]);
            var Channel = message.guild.channels.get(newLog)
            ...
            let incidentSuccess = new Discord.RichEmbed()
                .setAuthor(`${message.author.tag} | Setup Incident Logging`, message.author.displayAvatarURL)
    ...
    break;
        ...
        case 'serverlog': 
            ...
            let serverSuccess = new Discord.RichEmbed()
                .setAuthor(`${message.author.tag} | Setup Server Logging`, message.author.displayAvatarURL)
    ...
    break;
        ...
        case 'raidlog': 
            ...
            let raidSuccess = new Discord.RichEmbed()
                .setAuthor(`${message.author.tag} | Setup Raid Logging`, message.author.displayAvatarURL)
    ...
    break;
        ...
        case 'welcomelog': 
            ...
            let welcomeSuccess = new Discord.RichEmbed()
                .setAuthor(`${message.author.tag} | Setup Welcome Logging`, message.author.displayAvatarURL)
    ...
    break;
        ...
        let Category = message.guild.channels.get(categoryid)
        if (!Category || Category.type !== 'category') return message.channel.send(ticketsysError)

        let ticketsysSuccess = new Discord.RichEmbed()
            .setAuthor(`${message.author.tag} | Setup Ticket System`, message.author.displayAvatarURL)
    ...
    break;
        ...
        let actionEmbed = new Discord.RichEmbed()
            .setAuthor(`${message.author.tag} | Set / Setup`, message.author.displayAvatarURL)
        ...
        let action2Embed = new Discord.RichEmbed()
