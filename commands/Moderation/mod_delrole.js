...
module.exports.run = async (bot, message, args, client) => {
  ...
  if (logchannel) {
        ...
        let delRoleErrorEmbed = new Discord.RichEmbed()
            .setColor("#ff4f4f")
        ...
        roleName = args.join(" ")
        let delRole = (message.guild.roles.find(role => role.name === roleName) || message.guild.roles.get(args[0]))
        ...
        let delRoleEmbed = new Discord.RichEmbed()
            .setAuthor(`${message.author.tag} | Deleted role ❌`, message.author.displayAvatarURL)
