...
module.exports.run = async (bot, message, args, client) => {
    ...
    switch (OnOrOff) {
        case 'lvlmsg':
            ...
            let disablelvlmsg = new Discord.MessageEmbed()
                ...
                .setDescription(`${Success} Enabled level up message for the server`)
                .setColor(`#7aff7a`)
    ...
    break;    
        ...
        case 'lockdown':
            ...
            let enablelockdown = new Discord.MessageEmbed()
                ...
                .setDescription(`${Success} Enabled the lockdown function for the server`)
                .setColor(`#7aff7a`)
    ...
    break;
        ...
        case 'nsfw':
            ...
            let enableNSFW = new Discord.MessageEmbed()
                ...
                .setDescription(`${Success} Enabled NSFW for the server`)
                .setColor(`#7aff7a`)
    ...
    break;
        ...
        let disableDefaultEmbed = new Discord.MessageEmbed()
            ...
            .setDescription(`
${currPrefix.lvlmsg ? `${Success}` : `${Failure}`} | Level up message | \`${currPrefix.prefix}enable lvlmsg\`
${currPrefix.lockdown ? `${Success}` : `${Failure}`} | Lockdown during raid | \`${currPrefix.prefix}enable lockdown\`
${currPrefix.nsfw ? `${Success}` : `${Failure}`} | NSFW for the server | \`${currPrefix.prefix}enable nsfw\`
                `)
